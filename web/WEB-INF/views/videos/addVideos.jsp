            ...
            <div class="box-content">
                ...
                <form id="save_form" class="form-horizontal" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea id="paopao_videourl" class="form-control" placeholder="视频路径" data-toggle="tooltip"
                                      data-placement="bottom" title="Tooltip for name"/>
                        </div>
                    </div>
...
//        }
        ...
        $.ajax({
            ...
            type: "POST",
            url: "/saveVideos.do",
            data: {"title": title, "content": content, "picUrl": imagePath, "videoUrl": paopao_videourl},// 你的formid
            async: false,
            success: function (_data) {
                ...
                if (data.success) {
                    ...
                    var _case = {1: "标题不能为空", 2: "内容不能为空", 3: "请重新上传图片", 4: "请输入视频路径"};
